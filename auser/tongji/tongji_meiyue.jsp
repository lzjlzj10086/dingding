...
<%
	...
	String url = request.getSession().getServletContext().getRealPath("img")+"\\"+tu_mingzi;
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif' data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-23" data-genuitec-path="/licai/WebContent/auser/tongji/tongji_meiyue.jsp">
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-23" data-genuitec-path="/licai/WebContent/auser/tongji/tongji_meiyue.jsp">
				<tr bgcolor="#E7E7E7">
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" style="margin-top:8px">
		        <tr>
		            <td>
		                <%
		                   String url11="/licai/img/"+tu_mingzi;
		                %>
