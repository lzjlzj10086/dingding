...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif' data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-27" data-genuitec-path="/licai/WebContent/auser/userinfo/userPw.jsp">
			<form method="post" action="<%=path %>/userEdit.action" name="formPw" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-27" data-genuitec-path="/licai/WebContent/auser/userinfo/userPw.jsp">
