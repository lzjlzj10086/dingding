...
<html data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-16" data-genuitec-path="/licai/WebContent/auser/index.jsp">
  <head>
  ...
  <frameset rows="60,*" cols="*" frameborder="no" border="0" framespacing="0">
	  ...
	  <frameset cols="210,*" name="btFrame" frameborder="NO" border="0" framespacing="0">
	    ...
	    <frame src="<%=path %>/auser/index/picture.jsp" noresize name="main" scrolling="yes">
	  </frameset>
  </frameset>
  <noframes>
