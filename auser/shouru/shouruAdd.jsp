...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif' data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-20" data-genuitec-path="/licai/WebContent/auser/shouru/shouruAdd.jsp">
			<form method="post" action="<%=path %>/shouruAdd.action" name="formPw" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-20" data-genuitec-path="/licai/WebContent/auser/shouru/shouruAdd.jsp">
